package com.application.audio.jmp123.instream;

/*
 * SplitMultiplex.java -- 从MPEG-1,MPEG-2分离(读取)音频流 Copyright (C) 2010 This
...
public class MultiplexAudio extends RandomRead {
    ...
    private void pack() throws IOException {
        ...
        if ((buf[curPos + 4] & 0xf0) == 0x20) { // '0010 xxxx'
            ...
            if (this.duration == 0) {
                /*
                 * 1-bit: marker_bit 22-bit: mux_rate 1-bit: marker_bit
                 */
    ...
    private boolean audio_stream() throws IOException {
        ...
        while (true) {
            ...
            if ((startcode = buf[curPos + 3] & 0xff) < 0xb9) {
                // System.out.println("Not system stream. stream_id=" +
                // startcode + ", skip...");
                curPos += 4;
                continue;
            }
            ...
            switch (startcode) {
                ...
                case 0xc0: // '110x xxxx': audio stream
                    header_length = ((buf[curPos + 4] & 0xff) << 8)
                            | (buf[curPos + 5] & 0xff);
                    ...
                    if ((buf[curPos + 6] & 0xc0) == 0x80) {
                        ...
                        if ((buf[curPos + len] & 0xf0) == 0x20) { // '0010 xxxx'
                            ...
                            len += 5;
                        } else if ((buf[curPos + len] & 0xf0) == 0x30) { // '0011
                                                                         // xxxx'
                    ...
                    if (packet_data_bytes > 2324) {
                        // System.out.println("packet_data_byte_len=" +
                        // packet_data_bytes + " skip...");
                        curPos += 4;
                        break;
                    }
