/*
 * PlayBack.java -- 播放一个文件 Copyright (C) 2011 This program is free software: you
 ...
 * program. If not, see <http://www.gnu.org/licenses/>. If you would like to
 * negotiate alternate licensing terms, you may do so by contacting the author:
 * <http://jmp123.sourceforge.net/>
 */
package com.application.audio.jmp123;

import java.io.IOException;

import com.application.audio.jmp123.decoder.Header;
import com.application.audio.jmp123.decoder.IAudio;
import com.application.audio.jmp123.decoder.ID3Tag;
import com.application.audio.jmp123.decoder.Layer1;
import com.application.audio.jmp123.decoder.Layer123;
import com.application.audio.jmp123.decoder.Layer2;
import com.application.audio.jmp123.decoder.Layer3;
import com.application.audio.jmp123.instream.BuffRandReadFile;
import com.application.audio.jmp123.instream.BuffRandReadURL;
import com.application.audio.jmp123.instream.MultiplexAudio;
import com.application.audio.jmp123.instream.RandomRead;
 ...
 * <ul>
 * <li>可以调用PlayBack对象的 {@link #getHeader()} 方法获取 {@link jmp123.decoder.Header}
 * 对象；</li>
 * <li>可以调用PlayBack对象的 {@link #getID3Tag()} 方法获取 {@link jmp123.decoder.ID3Tag}
 * 对象；</li>
 * </ul>
...
public class PlayBack {
     ...
     * @param audio 指定的音频输出 {@link jmp123.decoder.IAudio} 对象。若指定为 <b>null</b>
     *            则只解码不播放输出。
    ...
    public boolean open(String name, String title) throws IOException {
        ...
        if (audio != null && title != null) {
            ...
            if (strArray.length >= 2) {
                 ...
                 * strbuilder.append(id3Tag.getTitle()); strbuilder.append('@');
    ...
    /**
     * 解码已打开的文件。
     * @param verbose 指定为 <b>true</b> 在控制台打印播放进度条。
