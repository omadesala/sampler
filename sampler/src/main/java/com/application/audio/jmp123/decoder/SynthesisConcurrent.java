...
/**
 * 一个声道多相频率倒置和多相合成滤波。用于两个声道并发运算。
 * <p>
 * 由于大量浮点运算，多相合成滤波耗时最多。解码一帧2声道MP3，实测多相合成滤波耗时占60%以上，若并发运算可提高解码速度。
 * <p>
 ...
 * </tr>
 * <tr>
 * <td align="left" colspan="4">注(1) CPU：双核2.93GHz / JDK： sun 1.6.0_27
 * <p>
 * (2) 基础测试是一个比较复杂的问题，本次测结果试并不一定是问题的最终结论。</td>
 * </tr>
 * </table>
 */
