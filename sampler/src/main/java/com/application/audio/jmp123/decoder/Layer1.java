/*
 * Layer1.java -- MPEG-1 Audio Layer I 解码 This program is free software: you can
 ...
 * <http://www.gnu.org/licenses/>. If you would like to negotiate alternate
 * licensing terms, you may do so by contacting the author:
...
public class Layer1 extends Layer123 {
    ...
    public int decodeFrame(byte[] b, int off) {
        ...
        int bound = (header.getMode() == 1) ? ((header.getModeExtension() + 1) * 4)
                : 32;
